...
select ROund(avg(purchase_amount),2) as avg_spend, subscription_status, count(customer_id) as total_customers, Round(sum(purchase_amount),2) as total_revenue
from customer
...
select subscription_status, count(customer_id) as total_purchases
from customer
